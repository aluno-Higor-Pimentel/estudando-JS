// função ou function --> Rotina (usamos a tag function para inicar uma função)
...
//multiplicar(); // isso faz o chamado da função
// log também é uma função
// isNaN() ele veririca se isso é um número ou não. Ou seja ela retorna uma valor boleano (true/false)

//const num= NaN;

//console.log("Hello");

//let result = isNaN(num); // true/ false
//console.log(result);
...
let result = isNaN(NaN); //tue ou false
console.log(result)

result = isFinite(Infinity);
console.log(result);

result = parseInt(12.4); // conversão do float para int
console.log(result);
...
// Código do porfessor abaixo

// Função ou Function -> Rotina

// Funções de Numéricas (Number -> Biblioteca)
let retorna = Number.isNaN(NaN); // true / false
console.log(result);
